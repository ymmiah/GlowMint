...
const Header: React.FC = () => {
  return (
    <header className="bg-[--color-surface-1]/70 backdrop-blur-lg border-b border-[--color-border]/50 sticky top-0 z-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
             <div className="w-10 h-10 bg-gradient-to-br from-[--color-primary] to-[--color-secondary] rounded-lg flex items-center justify-center shadow-lg">
            ...
            <span className="text-2xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[--gradient-from] to-[--gradient-to]">
              GlowMint
            </span>
          </div>
